...
/**
 * Modulo de habito 7, se presenta el menu de las actividades del habito
 */

@IonicPage()
@Component({
  selector: 'page-habito7',
  templateUrl: 'habito7.html',
})
export class Habito7Page {
  //variables
  loader: any;
  dia:any;
  loading: any;
  ...
  fondo:string;
  userData = { "id": "", "id_habito": "7", "registro": "actualizafecha" };
  /**
 * @ignore
 */
