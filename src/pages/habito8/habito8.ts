...
/**
 * Modulo de habito 8, se presenta el menu de las actividades del habito 
 */

@IonicPage()
@Component({
  selector: 'page-habito8',
  templateUrl: 'habito8.html',
})
export class Habito8Page {
  //variables
  loader: any;
  dia:any;
  loading: any;
  ...
  fondo:string;
  userData = { "id": "", "id_habito": "8", "registro": "actualizafecha" };
  /**
 * @ignore
 */
