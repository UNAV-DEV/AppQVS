...
/**
 * Modulo de habito 5, se presenta el menu de las actividades de habito
 */

@IonicPage()
@Component({
  selector: 'page-habito5',
  templateUrl: 'habito5.html',
})
export class Habito5Page {
  //variables
  loader: any;
  dia:any;
  loading: any;
  ...
  fondo:string;
  userData = { "id": "", "id_habito": "5", "registro": "actualizafecha" };
  /**
 * @ignore
 */
