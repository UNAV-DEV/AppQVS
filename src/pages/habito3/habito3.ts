...
/**
 * Modulo de habito 3, se presentan el menu de las actividades del habito
 */

@IonicPage()
@Component({
  selector: 'page-habito3',
  templateUrl: 'habito3.html',
})
export class Habito3Page {
  //variables
  loader: any;
  dia:any;
  loading: any;
  ...
  fondo:string;
  userData = { "id": "", "id_habito": "3", "registro": "actualizafecha" };
  /**
 * @ignore
 */
