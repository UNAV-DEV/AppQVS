...
/**
 * Modulo Habito 4, se presenta el menu de las actividades del habito
 */

@IonicPage()
@Component({
  selector: 'page-habito4',
  templateUrl: 'habito4.html',
})
export class Habito4Page {
//variables
  loader: any;
  dia:any;
  loading: any;
  ...
  fondo:string;
  userData = { "id": "", "id_habito": "4", "registro": "actualizafecha" };
  /**
 * @ignore
 */
